...
const DrawingForm: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      toast.error("Failed to generate drawings. Please try again.");
    }
  };
        ...
        <div className="glass rounded-xl p-6 text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Describe what you want, and our AI will generate several options. 
              Choose your favorite, then select a coloring page style. Customize 
              the print settings and you're ready to bring your creation to life!
            </p>
          </div>
        </div>
      </div>
