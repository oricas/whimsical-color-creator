      ...
      <header className="w-full py-4 px-6 md:px-8 border-b border-border/40 backdrop-blur-sm bg-background/80 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          >
            ...
            <span className="text-xl font-display font-bold bg-clip-text text-transparent bg-gradient-to-r from-king-800 to-king-600">
              King of Colors
            </span>
          </Link>
...
const MobileNavLink: React.FC<MobileNavLinkProps> = ({ to, icon, active }) => {
  return (
    <Link 
      to={to} 
      className={cn(
